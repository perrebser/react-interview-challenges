...
function App() {
  ...
  const { getCharacters, getCharacterDetails, getNextPage,getCharacterByName } = usePeople();
...
const timeout=setTimeout(()=>{
  getCharacterByName(userSearch).then((data)=>setCharacterResponse(data))
},400)
  ...
  return (
    <div>
      <div className="flex justify-center">
        ...
        <input className="mb-8 p-1 rounded-xl" placeholder="Luke Skywalker, R2D2..." value={userSearch} onChange={(e)=>handleInputChange(e)}></input>
        </div>
      </div>
